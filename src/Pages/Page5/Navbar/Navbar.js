...
const Navbar = () => {
    return (
        <>
            <nav className="backdrop-filter bg-gradient-to-r from-rose-50 via-white to-sky-50 px-2 sm:px-4 py-5 ">
                <div className="container flex flex-wrap items-center mx-auto justify-evenly">
                    ...
                    <div className='flex items-center'>
                        <ul className="flex flex-col mt-4 md:flex-row md:space-x-6 md:mt-0 md:text-sm md:font-medium">
                            <li>
                                <Link to='/home' className="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 md:hover:bg-transparent md:border-0 " aria-current="page">Sign in</Link>
                            </li>

                        </ul>
                        <button type="button" className="text-white text-base bg-[#BD8472] px-6 py-2 text-center rounded font-semibold">Take To Us</button>
                    </div>
                </div>
            </nav>
        </>
